...
/**
 * Class TrashBouncerMaintenanceImport
 *
 * Maintenance module "import".
 * @copyright  Holger Teichert 2005-2013
 * @author     Holger Teichert <post@complanar.de>
 * @package    trashbouncer
 */
class TrashBouncerMaintenanceImport extends TrashBouncerMaintenanceHelper implements executable
{
	...
	{
		return ($this->Input->post('FORM_SUBMIT') == 'tl_trashbouncer_maintenance_import');
	}
	...
	public function run()
	{
	  parent::run();
		...
		$objTemplate = new BackendTemplate('be_trashbouncer_import');
    ...
    $objTemplate->title = $GLOBALS['TL_LANG']['tl_trashbouncer_maintenance']['import'][0];
