...
$GLOBALS['TL_LANG']['tl_trashbouncer_maintenance'] = array(
  ...
  'chooseLanguagesError' => 'Bitte wählen Sie mindestens eine Sprache aus.',
  'export'      => array('Trainingsdaten exportieren', 'Exportieren Sie Trainingsdaten in eine Datei oder als Download.'),
  'chooseExportOptions' => array('Exportmethode', 'Bitte wählen aus, ob Sie den Export auf dem Server speichern oder als Download angeboten haben möchten. Die Datei wird gegebenenfalls im Dateiverzeichnis (%s) gespeichert.'),
  'exportOptions' => array('file'=>'Als Datei auf dem Server speichern', 'download'=>'Als Download anbieten'),
  ...
  'delete'      => array('Trainierte Sprache löschen', 'Es werden alle gespeicherten Daten (Training, Stop-/ignorierte Wörter und Protokoll) gelöscht. Sie können dabei eine Datensicherung anlegen lassen. Es werden nur Trainingsdaten, nicht aber das Protokoll gesichert.'),
  ...
  'exportSuccessful'    => array('Export erfolgreich.', 'Die gewünschten Trainingsdaten wurden in die Datei &quot;%s&quot; exportiert.'),
  ...
  'deleteConfirm'       => array('Ja, löschen', 'Wollen Sie wirklich die ausgewählten Sprachen vollständig aus der Datenbank löschen?'),
  'backup'              => array('Datensicherung', 'Die Datensicherung wird im Dateiverzeichnis (%s) abgelegt.'),
  'createBackup'        => 'Datensicherung anlegen',
  'doExport'            => 'Gewählte Sprachen exportieren',
  'doUpload'            => 'Importdatei hochladen',
  'doImport'            => 'Gewählte Sprachen importieren',
  'doReset'             => 'Gewählte Sprachen zurücksetzen',
  'doDelete'            => 'Gewählte Sprachen löschen'
);
